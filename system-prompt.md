...
Call request_human_input once, asking which row to begin scanning from. State the total data row count and suggest the first data row as the default. Set scan_cursor_row. Do not ask for a start row again unless the user asks to jump.
